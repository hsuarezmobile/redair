<?php
	...
	$data2 = "";
	$x = 0;	
	$json_viajar = json_decode($dataServ->getViajarById('1'));
	$data1 = $dataServ->renderfranquiciatabla1();
	$data2 = $dataServ->renderfranquiciatabla2();
	?>
<!DOCTYPE html>
                        ...
                        <section id="id-100" class="post single">
                            ...
                            <div class="post-header single">
                              <div style="color: #f42535">
                                    <h3 class="wow fadeInLeft animated">FRANQUICIA DE EQUIPAJE</h3>
...
<?php include ("includes/footer.php"); ?>
		...
		<script>
			//document.getElementById("tabledata1").innerHTML = "<?php echo $data1 ?>";
			//document.getElementById("tabledata2").innerHTML = "<?php echo $data2 ?>";
		</script>
