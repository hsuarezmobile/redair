    ...
    <body>
        ...
        <div id="searchdiv" class="search-toggle" style="z-index:999;position:absolute;float:left;top: 120px; width:100%;">
            <div class="containersearch"> 
				...
				<iframe class="kiuiframe" src="https://kibe-stage-ql.kiusys.net/widget/" style="display: block; -ms-overflow-style: none; overflow: hidden; overflow-y: hidden; margin-left: 20%; width: 446px; background-color: white; height: 615px;border-radius: 15px;padding: 21px;border-color:transparent;" scrolling="no"></iframe>
            </div>  
        </div>                                
