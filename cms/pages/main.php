...
<head>
    ...
    <title>Manejador de Contenidos Movil - RED AIR</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background-color: white;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand"><img src="../imgs/logo.png" style="float: left;top: 3px; position: absolute; left: 10px; height: 2em;"></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                    	...
                    	<li><a href="main.php?m=tarifa"><i class="fa fa-wrench fa-fw"></i>Tarifas especiales</a></li>                    	
						<?php  } ?>
						<?php  if ($dataServ->checkpermiso("tarifasequipaje")){ ?>
                    	<li><a href="main.php?m=tarifasequipaje"><i class="fa fa-wrench fa-fw"></i>Tarifas de equipaje</a></li>                    	
						<?php  } ?>
						<?php  if ($dataServ->checkpermiso("articulos")){ ?>
                    	<li><a href="main.php?m=articulos"><i class="fa fa-wrench fa-fw"></i>Artículos no indemnizables</a></li>                    	
						<?php  } ?>						
						<?php  if ($dataServ->checkpermiso("servicioscarga")){ ?>
                    	<li><a href="main.php?m=servicioscarga"><i class="fa fa-wrench fa-fw"></i>Servicios de carga</a></li>                    	
						<?php  } ?>							
						<?php  if ($dataServ->checkpermiso("itinerarios")){ ?>
                    	<li><a href="main.php?m=itinerarios"><i class="fa fa-wrench fa-fw"></i>Itinerarios</a></li>                    	
						<?php  } ?>													
						<?php  if ($dataServ->checkpermiso("noticia")){ ?>
                    	<li><a href="main.php?m=noticia"><i class="fa fa-wrench fa-fw"></i>Noticias</a></li>                    	
						<?php  } ?>
						<?php  if ($dataServ->checkpermiso("contenidos")){ ?>
                    	<li><a href="main.php?m=contenido"><i class="fa fa-wrench fa-fw"></i>Experiencia RED</a></li>                    	
						<?php  } ?>
						<?php  if ($dataServ->checkpermiso("contenidos2")){ ?>
                    	<li><a href="main.php?m=contenido2"><i class="fa fa-wrench fa-fw"></i>Contenidos Dinámicos</a></li>                    	
						<?php  } ?>								
						<?php  if ($dataServ->checkpermiso("viajar")){ ?>
                    	<li><a href="main.php?m=viajar"><i class="fa fa-wrench fa-fw"></i>Antes de viajar</a></li>                    	
						<?php  } ?>		
						<?php  if ($dataServ->checkpermiso("declaraciones")){ ?>
                    	<li><a href="main.php?m=declaraciones"><i class="fa fa-wrench fa-fw"></i>Declaraciones de pasajeros</a></li>                    	
						<?php  } ?>											
    ...
    <!-- /#wrapper -->
    <div id="successmsg" class="modal-content" style="display:none; top:30%; float: left; position: absolute; left: 10%; z-index: 9999; width: 80%;"> 
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="javascript:closeSuccessMessage();window.location=wheretogo;">Cerrar</button>
      </div>
    </div> 
    <div id="questionmsg" class="modal-content" style="display:none; top:30%; float: left; position: absolute; left: 10%; z-index: 9999; width: 80%;"> 
      <div class="modal-header">
    ...
    <div id="errormsg" class="modal-content" style="display:none; top:30%; float: left; position: absolute; left: 10%; z-index: 9999; width: 80%;"> 
      <div class="modal-header">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="javascript:closeErrorMessage();">Cerrar</button>
      </div>
    </div>   
