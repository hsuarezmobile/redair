<?php 
	...
	$id = $_GET["id"];
	$json_data = array();
	$json_data = json_decode($dataServ->getContenidosDinamicos($id));
?>
<script>
function validate() {
    let files = new FormData(),
		...
		$.ajax({
		   url : 'modules/contenido2_action.php',
		   type : 'POST',
		   data : formData,
		   processData: false,
		   contentType: false,
		   success : function(datax) {
				...
				if (myObj.response == "OK"){
					wheretogo = "main.php?m=contenido2";
					showSuccessMessage();
				}else{
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>Editar item de contenido</b>&nbsp;|&nbsp;<a href="javascript:window.location='?m=contenido2'">Regresar</a>
                        </div>
