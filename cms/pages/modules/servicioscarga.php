<?php 
	$x = 0;
	$json_data = array();
	$json_data = json_decode($dataServ->getServiciosCargaList());
?>            
<script>
function doDeleteTarifa(ids){
	wheretogoyes = "?m=dodeleteservicioscarga&id=" + ids;
	wheretogono = "#";
	wheretogo = "?m=settings";
	showQuestionMessage("¿Desea usted eliminar este servicio de carga?");		
}
function doEditTarifa(ids){
	window.location = "?m=servicioscarga_edit&id=" + ids;		
}
</script>
            <!-- /.row -->
            <br><div class="row">
                                ...
                                <div class="tab-pane fade in active" id="home">
						            <div class="row">
						                <div class="col-lg-12">
						                    <div class="panel panel-default">
						                        <div class="panel-heading">
						                            Listado de servicios de carga | <a href="main.php?m=servicioscarga_add">Agregar servicio de carga</a>
						                        </div>
						                        <!-- /.panel-heading -->
						                        <div class="panel-body">
						                                ...
						                                <tbody>
						                                	<?php if (isset($json_data->data)){ ?>
						                                		<?php for ($x = 0; $x < sizeof($json_data->data); $x++){ 
						                                			...
						                                			?>						                                
							                                    <tr class="odd gradeX">
							                                        <td><?php echo $json_data->data[$x]->tipo; ?></td>							                                        
