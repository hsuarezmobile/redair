<?php 
	...
	$id = $_GET["id"];
	$json_data = array();
	$json_data = json_decode($dataServ->getViajarById($id));
?>
<script>
function validate() {
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>Editar item antes de viajar</b>&nbsp;|&nbsp;<a href="javascript:window.location='?m=viajar'">Regresar</a>
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" id="form1" name="form1" method="post" action="javascript:validate();">
										...
										<div class="form-group">
											...
											<input id="nombre" class="form-control" value="<?php echo $json_data->articuloList[0]->nombre ?>">
										</div>
                                        <div class="form-group">
