								...
								<div id="block4" name="block4" style="width:100%">
									...
									<div id="div1block4" name="div1block4" class="div1block4">
										...
										<div style="width:100%; text-align:left; font-weight:bold;">
											...
											<?php echo "Secreción Nasal: ".decideSintoma($json_data->vitrinaList[0]->secrecionnasal); ?><br>											
											<?php echo "Escalofríos: ".decideSintoma($json_data->vitrinaList[0]->escalofrios); ?><br>											
