                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b>Agregar nueva tarifa</b>&nbsp;|&nbsp;<a href="javascript:window.location='?m=tarifa'">Regresar</a>
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" id="form1" name="form1" method="post" action="javascript:validate();">
                                        <div class="form-group">
                                            ...
                                            <input id="surname" class="form-control" placeholder="Ingrese nombre de la tarifa">
                                        </div>
                                        <div class="form-group">
                                            <label>Destino de la tarifa</label>
                                            <input id="destino" class="form-control" placeholder="Ingrese destino de la tarifa">
                                        </div>										
                                        <div class="form-group">
                                            <label>Monto de la tarifa</label>
                                            <input id="monto" class="form-control" placeholder="Ingrese monto de la tarifa">
                                        </div>																				
                                        <div class="form-group">
                                            <label>Imagen</label>
