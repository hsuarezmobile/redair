<?php
	...
	$data2 = "";
	$x = 0;
	$json_viajar = json_decode($dataServ->getViajarById('3'));
	$data1 = $dataServ->renderitinerariotabla1();
	$data2 = $dataServ->renderitinerariotabla2();	
	?>
<!DOCTYPE html>
                        ...
                        <section id="id-100" class="post single">
                            <div class="post-header single">
                              <div style="color: #32be66">
                                    <h3 class="wow fadeInLeft animated">ITINERARIOS</h3>
