                    ...
                    <div class="blog-lst col-md-12 pl0">
                        <section id="id-100" class="post single">
                            ...
                            <div style="text-align: justify"id="post-content" class="post-body single wow fadeInLeft animated">
                                <p>&nbsp;                                    </p>
                                <p>Somos la aerolínea venezolana con mayor trayectoria en el mercado nacional, ofrecemos el mejor servicio a bordo, acompañado de nuestra puntualidad, eficiencia y pronta respuesta de acuerdo a las necesidades y exigencias de los pasajeros.</p>
                                <p>
                                    <img src="assets/img/quienes_somos.jpg" class="img-responsive" alt="Example blog post alt">
                                </p>
